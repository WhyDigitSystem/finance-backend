...
//	}
	...
	public ResponseEntity<ResponseDTO> getGeneralJournalDocId(@RequestParam Long orgId, @RequestParam String finYear,
		...
		try {
			resultMap = transactionService.getGeneralJournalDocId(orgId, finYear, branch, branchCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseObjectsMap.put("generalJournalDocId", resultMap.get("docId"));
			responseObjectsMap.put("docDate", resultMap.get("docDate"));
...
//	}
	...
	public ResponseEntity<ResponseDTO> getpaymentVoucherDocId(@RequestParam Long orgId, @RequestParam String finYear,
		...
		try {
			resultMap = transactionService.getpaymentVoucherDocId(orgId, finYear, branch, branchCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"paymentVoucherDocId information retrieved successfully");

			responseObjectsMap.put("paymentVoucherDocId", resultMap.get("docId"));
			responseObjectsMap.put("docDate", resultMap.get("docDate"));

			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve paymentVoucherDocId information", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> updateCreateArApAdjustmentOffSet(
		...
		ResponseDTO responseDTO = null;
		try {
			Map<String, Object> arApAdjustmentOffSetVO = transactionService
	...
	public ResponseEntity<ResponseDTO> getArApAdjustmentOffSetDocId(@RequestParam Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"ArApAdjustmentOffSetDocId information retrieved successfully");
...
//	}
	...
	public ResponseEntity<ResponseDTO> getAdjustmentJournalDocId(@RequestParam Long orgId, @RequestParam String finYear,
		...
		try {
			resultMap = transactionService.getAdjustmentJournalDocId(orgId, finYear, branch, branchCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"adjustmentJournalDocId information retrieved successfully");

			responseObjectsMap.put("adjustmentJournalDocId", resultMap.get("docId"));
			responseObjectsMap.put("docDate", resultMap.get("docDate"));

			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve adjustmentJournalDocId information", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getSalesPersonFromPartyMaster(@RequestParam Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Failed to retrieve SalesPerson", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getAllCustomersFromPartyMaster(@RequestParam Long orgId) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Failed to CustomerName information",
					errorMsg);
		}
		LOGGER.debug(CommonConstant.ENDING_METHOD, methodName);
		return ResponseEntity.ok().body(responseDTO);
...
//	}
	...
	public ResponseEntity<ResponseDTO> getJobCardDocId(@RequestParam Long orgId, @RequestParam String finYear,
		...
		String methodName = "getJobCardDocId()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		...
		try {
			resultMap = transactionService.getJobCardDocId(orgId, finYear, branch, branchCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseObjectsMap.put("tmsJobCardDocId", resultMap.get("docId"));
			responseObjectsMap.put("docDate", resultMap.get("docDate"));

			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve tmsJobCardDocIdinformation", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getIncomeByTaxInvoice(@RequestParam Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Income retrieved successfully");
			responseObjectsMap.put("taxInvoiceVO", mapp);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap, "Failed to retrieve Income", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getExponesByCostInvoice(@RequestParam Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "Exponse retrieved successfully");
			responseObjectsMap.put("costInvoiceVO", mapp);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap, "Failed to retrieve Exponse", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getBankingDepositById(@RequestParam Long id) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "BankingDeposit information get successfully By Id");
			responseObjectsMap.put("bankingDepositVO", bankingDepositVO);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
...
//	}
	...
	public ResponseEntity<ResponseDTO> getBankingDepositDocId(@RequestParam Long orgId, @RequestParam String finYear,
		...
		try {
			resultMap = transactionService.getBankingDepositDocId(orgId, finYear, branch, branchCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"bankingDepositDocId information retrieved successfully");

			responseObjectsMap.put("bankingDepositDocId", resultMap.get("docId"));
			responseObjectsMap.put("docDate", resultMap.get("docDate"));

			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve bankingDepositDocId information", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getBankNameFromGroupforBankingDeposit(@RequestParam Long orgId) {
	...
	public ResponseEntity<ResponseDTO> updateCreateBankingWithdrawal(
		...
		ResponseDTO responseDTO = null;
		try {
			Map<String, Object> bankingWithdrawalVO = transactionService
					.updateCreateBankingWithdrawal(bankingWithdrawalDTO);
...
//	}
	...
	public ResponseEntity<ResponseDTO> getAllContraVoucherByOrgId(@RequestParam Long orgId) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "ContraVoucher information get successfully ByOrgId");
	...
	public ResponseEntity<ResponseDTO> getContraVoucherById(@RequestParam Long id) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE, "ContraVoucher information get successfully By Id");
			responseObjectsMap.put("contraVoucherVO", contraVoucherVO);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
	...
	public ResponseEntity<ResponseDTO> getAccountNamefromGroupLedgerforCV(@RequestParam Long OrgId) {
	...
	@GetMapping("/getAccountNameFromGroupLedgerGeneral")
	public ResponseEntity<ResponseDTO> getAccountNameFromGroupLedgerGeneral(@RequestParam Long OrgId) {

		String methodName = "getAccountNameFromGroupLedgerGeneral()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
		ResponseDTO responseDTO = null;
		List<Map<String, Object>> mov = new ArrayList<>();
		try {
			mov = transactionService.getAccountNameFromGroupLedgerGeneral(OrgId);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					" AccountName from GroupLedger for GeneralJournal information retrieved successfully");
			responseObjectsMap.put("GeneralJournalVO", mov);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve AccountName from GroupLedger for GeneralJournal information", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getSubLedgerNameFromPartyMaster(@RequestParam Long OrgId,
		...
		List<Map<String, Object>> mov = new ArrayList<>();
		try {
			mov = transactionService.getSubLedgerNameFromPartyMaster(OrgId, accountName);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Failed to retrieve PartyName   GeneralJournal information", errorMsg);
		}
