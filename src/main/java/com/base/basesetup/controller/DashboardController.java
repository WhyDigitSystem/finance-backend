...
public class DashboardController extends BaseController {
	...
	public ResponseEntity<ResponseDTO> getReceiptAmont(@RequestParam(required = true) Long orgId,
			@RequestParam(required = false) String month, @RequestParam String year) {
	...
	public ResponseEntity<ResponseDTO> getPaymentAmont(@RequestParam(required = true) Long orgId,
	...
	public ResponseEntity<ResponseDTO> getTdsSummary(@RequestParam(required = true) Long orgId,
			@RequestParam(required = false) String month, @RequestParam(required = true) Long finYear) {
	...
	public ResponseEntity<ResponseDTO> getPercentageDiffFromRevenue(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = true) String Month,
			@RequestParam(required = true) String Year, @RequestParam(required = true) String branchCode) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Revenue Information Reterive Failed",
					errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getPercentageDiffFromCost(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = false) String month,
	...
	public ResponseEntity<ResponseDTO> getPercentageFromReceipt(@RequestParam(required = true) Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Receipt Information Reterive Failed",
					errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getPercentageFromPayment(@RequestParam(required = true) Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Payment Information Reterive Failed",
					errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getSalesMonthWiseData(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = false) String branchCode) {
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"Sales MonthWise Data Information  retrieved successfully");
			responseObjectsMap.put("Payment", receiptAmont);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Sales MonthWise Data Information Reterive Failed", errorMsg);
		}
	...
	public ResponseEntity<ResponseDTO> getTotaltdsFromCustomer(@RequestParam(required = true) Long orgId,
		...
		if (StringUtils.isBlank(errorMsg)) {
			...
			responseDTO = createServiceResponseError(responseObjectsMap, "Customer Tds Information Reterive Failed",
					errorMsg);
		}
	...
	@GetMapping("/getRevenueMonthWiseRevenue")
	public ResponseEntity<ResponseDTO> getRevenueMonthWiseRevenue(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = true) String monthName) {
		String methodName = "getRevenueMonthWiseRevenue()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
		ResponseDTO responseDTO = null;
		...
		try {
			receiptAmont = dashboardService.getRevenueMonthWiseRevenue(orgId, finYear, monthName);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"Revenue MonthWise Data Information  retrieved successfully");
			responseObjectsMap.put("Payment", receiptAmont);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Revenue  MonthWise Data Information Reterive Failed", errorMsg);
		}
	...
	@GetMapping("/getRevenueMonthWiseCost")
	public ResponseEntity<ResponseDTO> getRevenueMonthWiseCost(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = true) String monthName) {
		String methodName = "getRevenueMonthWiseCost()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
		ResponseDTO responseDTO = null;
		...
		try {
			receiptAmont = dashboardService.getRevenueMonthWiseCost(orgId, finYear, monthName);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"Cost MonthWise Data Information  retrieved successfully");
			responseObjectsMap.put("Payment", receiptAmont);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Cost MonthWise Data Information Reterive Failed", errorMsg);
		}
	...
	@GetMapping("/getRevenueMonthWiseRecepit")
	public ResponseEntity<ResponseDTO> getRevenueMonthWiseRecepit(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = true) String monthName) {
		String methodName = "getRevenueMonthWiseRecepit()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
		ResponseDTO responseDTO = null;
		...
		try {
			receiptAmont = dashboardService.getRevenueMonthWiseRecepit(orgId, finYear, monthName);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"Receipt MonthWise Data Information  retrieved successfully");
			responseObjectsMap.put("Payment", receiptAmont);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
					"Receipt MonthWise Data Information Reterive Failed", errorMsg);
		}
	...
	@GetMapping("/getRevenueMonthWisePayment")
	public ResponseEntity<ResponseDTO> getRevenueMonthWisePayment(@RequestParam(required = true) Long orgId,
			@RequestParam(required = true) Long finYear, @RequestParam(required = true) String monthName) {
		String methodName = "getRevenueMonthWisePayment()";
		LOGGER.debug(CommonConstant.STARTING_METHOD, methodName);
		String errorMsg = null;
		Map<String, Object> responseObjectsMap = new HashMap<>();
		ResponseDTO responseDTO = null;
		...
		try {
			receiptAmont = dashboardService.getRevenueMonthWisePayment(orgId, finYear, monthName);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
		...
		if (StringUtils.isBlank(errorMsg)) {
			responseObjectsMap.put(CommonConstant.STRING_MESSAGE,
					"Payment MonthWise Data Information  retrieved successfully");
			responseObjectsMap.put("Payment", receiptAmont);
			responseDTO = createServiceResponse(responseObjectsMap);
		} else {
			responseDTO = createServiceResponseError(responseObjectsMap,
