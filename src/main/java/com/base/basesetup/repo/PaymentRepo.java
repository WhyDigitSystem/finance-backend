...
//	String getPaymentDocId(Long orgId, String finYear, String branchCode, String screenCode);
	...
	List<Object[]> getPaymentDocId(Long orgId, String finYear, String branchCode, String screenCode);
...
//	Set<Object[]> getPaymentFillGrid(Long orgId, String partyCode,String branchCode);
	...
	@Query(nativeQuery = true, value = "select \r\n"
			...
			+ ") t")
	Set<Object[]> getPaymentCount(Long orgId,String finYear, String branchCode);
