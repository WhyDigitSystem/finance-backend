...
public interface PaymentRepo extends JpaRepository<PaymentVO, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT   \r\n"
			...
			+ "			      b.chargeamt,  \r\n"
			+ "			      b.settled,  \r\n"
			+ "			      b.outstanding ,a.status  ,a.approvestatus  \r\n"
			+ "			  FROM   \r\n"
			+ "			      finance_aip.payment a,  \r\n"
			+ "			      finance_aip.paymentinvdtls  b  \r\n"
			+ "			  WHERE   \r\n"
			...
			+ "			  ORDER BY   \r\n"
			+ "			      a.createdon desc")
	Set<Object[]> getPaymentDetails(Long orgId, String finYear, String partyname, String fromDate, String toDate);
	...
	@Query(nativeQuery = true, value = "SELECT   \r\n"
			...
			+ "			      a.tdsamt,   \r\n"
			+ "			      a.onaccount,   \r\n"
			+ "			      a.bankcashacc ,a.status  ,a.approvestatus \r\n"
			+ "			  FROM   \r\n"
			+ "			      finance_aip.payment a  \r\n"
			+ "			  WHERE   \r\n"
			+ "			      a.orgid =     ?1  \r\n"
			...
			+ "			  ORDER BY   \r\n"
			+ "			      a.createdon DESC")
	Set<Object[]> getPaymentSummary(Long orgId, String finYear, String partyname, String fromDate, String toDate);
