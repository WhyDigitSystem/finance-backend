...
public interface PaymentRepo extends JpaRepository<PaymentVO, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT \r\n"
			...
			+ "ORDER BY \r\n"
			+ "    a.createdon DESC")
	Set<Object[]> getPaymentDetails(Long orgId,String partyname, String fromDate, String toDate, String branchCode);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n"
			...
			+ "ORDER BY \r\n"
			+ "    a.createdon DESC")
	Set<Object[]> getPaymentSummary(Long orgId, String partyname, String fromDate, String toDate,String branchCode);
