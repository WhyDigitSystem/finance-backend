...
//	CostDebitNoteVO getDebitNoteByDocIdandScreenCode(String screenCode, String docId);
	...
	@Query(nativeQuery = true, value = "select 1 as sno, a.docid,a.docdate,a.refno,a.refdate,c.supplietype,c.suppliercode,c.suppliername,c.suppliergstin,d.currency,d.exrate,d.gstpercent,sum(d.gstamount) as gstAmount,sum(d.lcamt) as chargeAmount ,sum(d.billamt) as billAmount,c.actbillcurramt as totalAmountLc from accountsdetails b, accounts a,costinvoice c,chargercostinvoice d where \r\n"
			...
			+ "group by a.docid,a.docdate,a.refno,a.refdate,c.supplietype,c.suppliercode,c.suppliername,c.suppliergstin,d.currency,d.exrate,d.gstpercent,c.actbillcurramt\r\n"
			+ " union\r\n"
			+ "select 2 as sno, a.docid,a.docdate,a.refno,a.refdate,c.supplietype,c.suppliercode,c.suppliername,c.suppliergstin,d.currency,d.exrate,d.gstpercent,sum(d.gstamount) as gstAmount,sum(d.lcamt) as chargeAmount ,sum(d.billamt) as billAmount,c.actbillcurramt as totalAmountLc from accountsdetails b, accounts a,costdebitnote c,chargercostdebitnote d where \r\n"
			...
			+ "        AND c.orgid =?1\r\n"
			+ "    GROUP BY \r\n"
			+ "        a.docid, a.docdate, a.refno, a.refdate,\r\n"
