...
public interface RegisterCostInvoiceGnaRepo extends JpaRepository<RegisterCostInvoiceGnaVO, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT\r\n"
			...
			+ "(\r\n"
			+ "\r\n"
			+ "   SELECT      branchcode,     evid,     evdate,\r\n"
			+ "\r\n"
			+ "			    suppliername,     suppliergstin,     gsttype,\r\n"
			+ "\r\n"
			+ "			    SUM(billamount) AS billamount,     SUM(totalamount) AS totalamount,\r\n"
			+ "\r\n"
			+ "			    SUM(tds) AS tds,     SUM(partyPayable) AS partyPayable,\r\n"
			+ "\r\n"
			+ "			    SUM(igst) AS Output_IGST,     SUM(cgst) AS Output_CGST,\r\n"
			+ "\r\n"
			+ "			    SUM(sgst) AS Output_SGST,     MAX(gstpercent) AS gstpercent,     docid,\r\n"
			+ "\r\n"
			+ "			    docdate,     screencode FROM (     SELECT          a.branchcode,\r\n"
			+ "\r\n"
			+ "			        a.vid AS evid,         a.vdate AS evdate,         a.suppliername,\r\n"
			+ "\r\n"
			+ "			        a.suppliergstin,         a.gsttype,         a.totchargeslcamt AS billamount,\r\n"
			+ "\r\n"
			+ "			        (a.totchargeslcamt + a.gstinputlcamt) AS totalamount,         d.totaltds AS tds,\r\n"
			+ "\r\n"
			...
			+ "\r\n"
			+ "			        b.gstpercent,         a.docid,         a.docdate,\r\n"
			+ "\r\n"
			+ "			        a.screencode     FROM          costinvoice a\r\n"
			+ "\r\n"
			+ "			        JOIN chargercostinvoice b ON a.costinvoiceid = b.costinvoiceid\r\n"
			+ "\r\n"
			+ "			        JOIN accounts c ON a.docid = c.refno AND a.vid = c.vid\r\n"
			+ "\r\n"
			+ "			        JOIN tdscostinvoice d ON a.costinvoiceid = d.costinvoiceid     WHERE \r\n"
			+ "\r\n"
			+ "			        a.cancel = 'F'         AND a.orgid =?1 \r\n"
			+ "\r\n"
			...
			+ "\r\n"
			+ "			        a.vid,         a.vdate,         a.suppliername,\r\n"
			+ "\r\n"
			+ "			        a.suppliergstin,         a.gsttype,         a.totchargeslcamt ,\r\n"
			+ "\r\n"
			+ "			        a.gstinputlcamt ,d.totaltds,a.netbilllcamt, b.gstpercent,         a.docid,\r\n"
			+ "\r\n"
			+ "			        a.docdate,         a.screencode       UNION ALL \r\n"
			+ "\r\n"
			+ "			    SELECT          a.branchcode,         a.vid AS evid,\r\n"
			+ "\r\n"
			+ "			        a.vdate AS evdate,         a.suppliername,         a.suppliergstin,\r\n"
			+ "\r\n"
			+ "			        a.gsttype,         a.totchargeslcamt * -1 AS billamount,\r\n"
			+ "\r\n"
			+ "			        (a.totchargeslcamt + a.gstinputlcamt) * -1 AS totalamount,\r\n"
			+ "\r\n"
			+ "			        d.totaltds * -1 AS tds,         a.netbilllcamt * -1 AS partyPayable,\r\n"
			+ "\r\n"
			+ "			        cast(case when  a.gsttype='INTER' then   a.gstinputlcamt else 0 end as decimal(18,2)) as igst,\r\n"
			+ "\r\n"
			+ "			         cast(case when  a.gsttype='INTRA' then   a.gstinputlcamt/2 else 0 end as decimal(18,2)) as cgst,\r\n"
			...
			+ "			        b.gstpercent,         a.docid,         a.docdate,\r\n"
			+ "\r\n"
			+ "			        a.screencode     FROM          costdebitnote a\r\n"
			+ "\r\n"
			+ "			        JOIN chargercostdebitnote b ON a.costdebitnoteid = b.costdebitnoteid\r\n"
			+ "\r\n"
			+ "			        JOIN accounts c ON a.docid = c.refno AND a.vid = c.vid\r\n"
			+ "\r\n"
			+ "			        JOIN costdebitnotetaxprtcul d ON a.costdebitnoteid = d.costdebitnoteid     WHERE \r\n"
			+ "\r\n"
			+ "			        a.cancel = 'F'         AND a.orgid = ?1\r\n"
			+ "\r\n"
			+ "			        AND (?2 = 'ALL' OR a.branchcode = ?2)\r\n"
			...
			+ "			        a.gstinputlcamt ,d.totaltds,a.netbilllcamt, b.gstpercent,         a.docid,\r\n"
			+ "\r\n"
			+ "			        a.docdate,         a.screencode  ) AS combined_data GROUP BY \r\n"
			+ "\r\n"
			+ "			    branchcode,     evid,     evdate,     suppliername,\r\n"
			+ "\r\n"
			+ "			    suppliergstin,     gsttype,     docid,     docdate,\r\n"
			+ "\r\n"
			+ "			    screencode ORDER BY      evid,      evdate\r\n"
			+ "\r\n"
			+ ") combined_data\r\n"
			+ "\r\n"
			+ "\r\n"
			...
			+ "\r\n"
			+ "    SUM(Output_IGST) AS Output_IGST,\r\n"
			+ "\r\n"
			...
			+ "			        AND ((?3 IS NULL AND ?4 IS NULL) OR c.vdate BETWEEN DATE(?3) AND DATE(?4))\r\n"
			+ "\r\n"
			+ "			        AND ('ALL' = 'ALL' OR a.suppliercode = 'ALL')and a.finyear=?6 group by a.branchcode,\r\n"
			+ "\r\n"
			+ "			        a.vid,         a.vdate,         a.suppliername,\r\n"
			+ "\r\n"
			+ "			        a.suppliergstin,         a.gsttype,         a.totchargeslcamt ,\r\n"
			...
			+ "ORDER BY\r\n"
			+ "\r\n"
			+ "    CASE WHEN evid = 'Total' THEN 1 ELSE 0 END,\r\n"
			+ "\r\n"
			+ "    evdate,\r\n"
			+ "\r\n"
			+ "    evid")
