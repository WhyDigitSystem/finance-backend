...
//	String getTaxInvoiceDocId(Long orgId, String finYear, String branchCode, String screenCode);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n"
			...
			+ "    NULL AS voucherdate,\r\n"
			+ "    NULL AS billtoparty,\r\n"
			+ "    NULL AS controllingoff,\r\n"
			+ "    NULL AS billcurr,\r\n"
			+ "    NULL AS billcurrrate,\r\n"
			+ "    SUM(totalinvamountbc) AS totalinvamountbc,\r\n"
			+ "    SUM(totalinvamountlc) AS totalinvamountlc,\r\n"
			+ "    SUM(totaltaxableamountlc) AS totaltaxableamountlc,\r\n"
			+ "    NULL AS gsttype,\r\n"
			+ "    SUM(totaltaxamountlc) AS totaltaxamountlc,\r\n"
			+ "    SUM(totaltaxamountbc) AS totaltaxamountbc,\r\n"
			+ "    SUM(roundoffamountlc) AS roundoffamountlc,\r\n"
			+ "    SUM(fcamt) AS fcamt,\r\n"
			+ "    SUM(lcamt) AS lcamt,\r\n"
			+ "    AVG(rate) AS rate,\r\n"
			...
			+ "    AND a.finyear = ?6\r\n"
			+ "    GROUP BY\r\n"
			+ "        a.totalinvamountbc, a.totalinvamountlc, a.totaltaxableamountlc,\r\n"
			+ "        a.totaltaxamountlc, a.totaltaxamountbc, a.roundoffamountlc\r\n"
			+ "    \r\n"
			+ "    UNION ALL\r\n"
			+ "    \r\n"
			+ "    -- Subquery for irncreditnote data (negative amounts)\r\n"
			+ "    SELECT \r\n"
			+ "        a.totalinvamountbc * -1 AS totalinvamountbc,\r\n"
			+ "        a.totalinvamountlc * -1 AS totalinvamountlc,\r\n"
			+ "        a.totaltaxableamountlc,\r\n"
			+ "        a.totaltaxamountlc * -1 AS totaltaxamountlc,\r\n"
			+ "        0 AS totaltaxamountbc,\r\n"
			+ "        a.roundoffamountlc,\r\n"
			+ "        SUM(b.fcamount) AS fcamt,\r\n"
			+ "        SUM(b.lcamount) * -1 AS lcamt,\r\n"
			...
			+ "    GROUP BY\r\n"
			+ "        a.totalinvamountbc, a.totalinvamountlc, a.totaltaxableamountlc,\r\n"
			+ "        a.totaltaxamountlc, a.roundoffamountlc\r\n"
			+ ") AS combined_data\r\n"
			+ "\r\n"
			+ "ORDER BY\r\n"
			+ "    CASE WHEN vid = 'TOTAL' THEN 1 ELSE 0 END,\r\n"
			+ "    vdate,\r\n"
			+ "    vid")
