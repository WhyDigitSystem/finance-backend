...
//	List<TaxInvoiceVO> getCheck(Long orgId, String party);
	...
	@Query(nativeQuery = true, value = "select 1 as sno, a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,c.partyname,c.recipientgstin,d.currency,d.exrate,d.gstpercent,sum(d.gstamount) as gstAmount,sum(lcamount) as chargeAmount ,sum(d.billamount) as billAmount,c.totalinvamountlc as totalAmountLc from accountsdetails b, accounts a,taxinvoice c,taxinvoicedetails d where \r\n"
			...
			+ "group by a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,c.partyname,c.recipientgstin,d.currency,d.exrate,d.gstpercent,c.totalinvamountlc \r\n"
			+ " union\r\n"
			+ "select 2 as sno,a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,c.partyname,c.recipientgstin,d.currency,d.exrate,d.gstpercent,sum(d.gstamount) as gstAmount,sum(lcamount) as chargeAmount ,sum(d.billamount) as billAmount,c.totalinvamountlc as totalAmountLc from accountsdetails b, accounts a,irncreditnote c,irncreditnotedetails d where \r\n"
			...
			+ "    SUM(totalAmountLc)\r\n"
			+ "FROM (\r\n"
			+ "    select 1 as sno, a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,c.partyname,\r\n"
			...
			+ "      and c.orgid=?1\r\n"
			+ "    group by a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,\r\n"
			+ "             c.partyname,c.recipientgstin,d.currency,d.exrate,d.gstpercent,\r\n"
			+ "             c.totalinvamountlc \r\n"
			+ "\r\n"
			+ "    UNION ALL\r\n"
			+ "\r\n"
			+ "    select 2 as sno, a.docid,a.docdate,a.refno,a.refdate,c.partytype,c.partycode,c.partyname,\r\n"
			+ "           c.recipientgstin,d.currency,d.exrate,d.gstpercent,\r\n"
			+ "           sum(d.gstamount) as gstAmount,\r\n"
			+ "           sum(lcamount) as chargeAmount,\r\n"
			+ "           sum(d.billamount) as billAmount,\r\n"
