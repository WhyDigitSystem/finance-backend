...
//	Set<Object[]> getStatedetailsFromPartyMaster(Long orgId, String partyCode);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n"
			...
			+ "            a.suppliergstin,\r\n"
			+ "            a.gsttype,\r\n"
			+ "            a.totchargeslcamt billamount,\r\n"
			+ "            a.gstinputlcamt tax,\r\n"
			+ "            (a.totchargeslcamt + a.gstinputlcamt) totalamount,\r\n"
			+ "            d.totaltds tds,\r\n"
			+ "            a.netbilllcamt AS partyPayable,\r\n"
			+ "            gstpercent AS gstpercent\r\n"
			+ "        FROM \r\n"
			+ "            costinvoice a,\r\n"
			+ "            chargercostinvoice b , \r\n"
			+ "            accounts c ,\r\n"
			+ "            tdscostinvoice d\r\n"
			+ "        WHERE \r\n"
			+ "        a.costinvoiceid = b.costinvoiceid and\r\n"
			+ "            a.cancel = 'F'\r\n"
			+ "            and a.costinvoiceid=d.costinvoiceid\r\n"
			+ "            and a.docid = c.refno AND a.vid = c.vid\r\n"
			+ "            AND a.orgid = ?1\r\n"
