...
//			+ "    SELECT \r\n"
//			+ "        branchcode,\r\n"
//			+ "        evid,  -- Changed from \"vid\" to \"evid\"\r\n"
//			+ "        evdate,  -- Changed from \"vdate\" to \"evdate\"\r\n"
//			+ "        supplietype,\r\n"
//			+ "        suppliername,\r\n"
//			+ "        supplierbillno,\r\n"
//			+ "        suppliergstin,\r\n"
...
//			+ "            c.docid,\r\n"
//			+ "            c.docdate,\r\n"
//			+ "            a.vid AS evid,  -- Ensure aliasing correctly\r\n"
//			+ "            a.vdate AS evdate,  -- Ensure aliasing correctly\r\n"
//			+ "            a.supplietype,\r\n"
//			+ "            a.suppliername,\r\n"
//			+ "            a.supplierbillno,\r\n"
//			+ "            a.suppliergstin,\r\n"
...
//			+ "            costinvoice a\r\n"
//			+ "        JOIN \r\n"
//			+ "            chargercostinvoice b ON a.costinvoiceid = b.costinvoiceid\r\n"
//			+ "        JOIN \r\n"
...
//			+ "                OR ?4 IS NULL \r\n"
//			+ "                OR ?4 = ''\r\n"
//			+ "                OR c.vdate BETWEEN STR_TO_DATE(?3, '%Y-%m-%d') \r\n"
//			+ "                               AND STR_TO_DATE(?4, '%Y-%m-%d')\r\n"
//			+ "            )\r\n"
//			+ "            AND (a.branchcode = ?2 OR ?2 = 'ALL')\r\n"
//			+ "        GROUP BY \r\n"
//			+ "            a.branchcode, c.docid, c.docdate, a.vid, a.vdate, \r\n"
//			+ "            a.supplietype, a.suppliername, a.supplierbillno, \r\n"
//			+ "            a.suppliergstin, a.gsttype\r\n"
//			+ "    ) AS a\r\n"
//			+ ") AS b\r\n"
//			+ "GROUP BY \r\n"
//			+ "    branchcode, evid, evdate, supplietype, suppliername, \r\n"
//			+ "    supplierbillno, suppliergstin, gsttype\r\n"
//			+ "ORDER BY \r\n"
//			+ "    evid, evdate",nativeQuery =true)
