...
//	Set<Object[]> getStatedetailsFromPartyMaster(Long orgId, String partyCode);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n" + "    branchcode,\r\n" + "    evid,\r\n" + "    evdate,\r\n"
			...
			+ "        cast(case when  a.gsttype='INTER' then   a.gstinputlcamt else 0 end as decimal(18,2)) as igst,\r\n"
			+ "        cast(case when  a.gsttype='INTRA' then   a.gstinputlcamt/2 else 0 end as decimal(18,2)) as cgst,\r\n"
			+ "        cast(case when  a.gsttype='INTRA' then   a.gstinputlcamt/2 else 0 end as decimal(18,2)) as sgst,\r\n"
			+ "        b.gstpercent,\r\n" + "        a.docid,\r\n" + "        a.docdate,\r\n"
			+ "        a.screencode\r\n" + "    FROM \r\n" + "        costinvoice a\r\n"
			...
			+ "        a.vid,\r\n" + "        a.vdate,\r\n" + "        a.suppliername,\r\n"
			+ "        a.suppliergstin,\r\n" + "        a.gsttype,\r\n" + "        a.totchargeslcamt ,\r\n"
			+ "        a.gstinputlcamt ,d.totaltds,a.netbilllcamt, b.gstpercent,\r\n" + "        a.docid,\r\n"
			+ "        a.docdate,\r\n" + "        a.screencode \r\n" + "\r\n" + "    UNION ALL\r\n" + "\r\n"
			+ "    SELECT \r\n" + "        a.branchcode,\r\n" + "        a.vid AS evid,\r\n"
			+ "        a.vdate AS evdate,\r\n" + "        a.suppliername,\r\n" + "        a.suppliergstin,\r\n"
