...
public interface ReceiptRepo extends JpaRepository<ReceiptVO, Long> {
	...
	@Query(nativeQuery = true, value = "WITH b AS (\r\n"
			...
			+ "    a.acccurrency,\r\n"
			+ "    a.exrate,\r\n"
			+ "    SUM(d.totalchargeamountlc - COALESCE(h.totalchargeamountlc, 0) - COALESCE(r.tdsamt, 0)) AS totalAmount,\r\n"
			+ "    SUM(d.totalinvamountlc - COALESCE(h.totalinvamountlc, 0)) - COALESCE(n.settamt, 0) AS invamount,\r\n"
			+ "    a.chargableamt,\r\n"
			+ "    a.tdsamt,\r\n"
			+ "    t.gstpercent,\r\n"
			+ "    SUM(d.totaltaxamountlc - COALESCE(h.totaltaxamountlc, 0)) AS gstamount\r\n"
			+ "FROM arapdetails a\r\n"
			+ "LEFT JOIN b \r\n"
			...
			+ "JOIN taxinvoice d \r\n"
			+ "    ON a.refno = d.docid\r\n"
			+ "JOIN taxinvoice_totals t \r\n"
			+ "    ON d.taxinvoiceid = t.taxinvoiceid\r\n"
			+ "JOIN accounts c \r\n"
			+ "    ON a.docid = c.docid\r\n"
			+ "LEFT JOIN receipt r \r\n"
			+ "    ON r.customercode = d.partycode \r\n"
			+ "LEFT JOIN irncreditnote h \r\n"
			+ "    ON d.docid = h.originbillno \r\n"
			+ "    AND h.approvestatus = 'Approved'\r\n"
			+ "LEFT JOIN n \r\n"
			+ "    ON n.orgid = a.orgid \r\n"
			+ "    AND n.refno = c.vid\r\n"
			+ "WHERE \r\n"
			...
			+ "    n.settamt\r\n"
			+ "HAVING \r\n"
			+ "    SUM(d.totalinvamountlc - COALESCE(h.totalinvamountlc, 0) - COALESCE(r.tdsamt, 0)) - COALESCE(n.settamt, 0) > 0\r\n"
			+ "ORDER BY \r\n"
			+ "    a.refdate,\r\n"
			+ "    c.vid")
