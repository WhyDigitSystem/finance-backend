...
public interface ReceiptRepo extends JpaRepository<ReceiptVO, Long> {
	...
	@Query(nativeQuery = true, value = "WITH b AS (\r\n"
			...
			+ "    ON d.docid = h.originbillno AND h.approvestatus = 'Approved'\r\n"
			+ "LEFT JOIN n \r\n"
			+ "    ON n.orgid = a.orgid AND n.refno = c.vid\r\n"
			+ "WHERE \r\n"
			+ "    d.branchcode =?3\r\n"
			+ "    AND a.cancel = 'F'\r\n"
			...
			+ "    n.settamt\r\n"
			+ "HAVING \r\n"
			+ "    SUM(d.totalinvamountlc - COALESCE(h.totalinvamountlc, 0)) - COALESCE(n.settamt, 0) > 0\r\n"
			+ "ORDER BY \r\n"
			+ "    a.refdate,\r\n"
			+ "    c.vid")
