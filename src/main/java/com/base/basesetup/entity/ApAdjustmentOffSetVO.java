...
@Entity
@Table(name = "apadjustmentoffset")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ApAdjustmentOffSetVO {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apadjustmentoffsetgen")
	@SequenceGenerator(name = "apadjustmentoffsetgen", sequenceName = "apadjustmentoffsetseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "apadjustmentoffsetid")
	private Long id;
	...
	@Column(name = "paymentdocid",length = 50)
	private String paymentDocId;
	@Column(name = "paymentdocdate")
	...
	private String screenCode="APA";
	@Column(name = "screenname",length = 30)
	private String screenName="APADJUSTMENTOFFSET";
	...
	@OneToMany(mappedBy = "apAdjustmentOffSetVO",cascade = CascadeType.ALL)
	@JsonManagedReference
	List<ApOffSetInvoiceDetailsVO> apOffSetInvoiceDetailsVO;
