...
@Entity
@Table(name = "apoffsetinvoicedetails")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ApOffSetInvoiceDetailsVO {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apoffsetinvoicedetailsgen")
	@SequenceGenerator(name = "apoffsetinvoicedetailsgen", sequenceName = "apoffsetinvoicedetailsseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "apoffsetinvoicedetailsid")
	private Long id;
	...
	@ManyToOne
	@JsonBackReference
	@JoinColumn(name = "apadjustmentoffsetid")
	ApAdjustmentOffSetVO apAdjustmentOffSetVO;
